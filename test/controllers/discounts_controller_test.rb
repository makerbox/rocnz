...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { customer: @discount.customer, customertype: @discount.customertype, discount: @discount.discount, product: @discount.product, producttype: @discount.producttype }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { customer: @discount.customer, customertype: @discount.customertype, discount: @discount.discount, product: @discount.product, producttype: @discount.producttype }
    assert_redirected_to discount_path(assigns(:discount))
  end
