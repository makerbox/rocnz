...
class QuantitiesControllerTest < ActionController::TestCase
  ...
  test "should create quantity" do
    assert_difference('Quantity.count') do
      post :create, quantity: { order_id: @quantity.order_id, product_id: @quantity.product_id, qty: @quantity.qty }
    end
  ...
  test "should update quantity" do
    patch :update, id: @quantity, quantity: { order_id: @quantity.order_id, product_id: @quantity.product_id, qty: @quantity.qty }
    assert_redirected_to quantity_path(assigns(:quantity))
  end
