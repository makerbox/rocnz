class TestController < ApplicationController
	...
	def index
       ...
       Product.all.each do |disco|
       	...
       	# @results << '-------------------------'
              @results << Discount.all.where(product: (disco.group || disco.code || disco.pricecat), customer: (current_user.account.code.strip || current_user.account.discount.strip)).discount
       end
       #      	@results << cust.strip
       #      	@results << '='
       #      	@results << discount
