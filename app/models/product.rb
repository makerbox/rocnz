...
def calc_discount(user, price)
	# if Discount.where(producttype: 'group_percent', product: self.group, customertype: 'code_percent', customer: user.account.code)
		if Discount.where(producttype: 'group_percent', product: self.group, customertype: 'code_percent', customer: user.account.code).exists?
			discount = Discount.where(producttype: 'group_percent', product: self.group, customertype: 'code_percent', customer: user.account.code).discount
			discount = (price / 100) * discount
			price - discount
		elsif Discount.where(producttype: 'group_percent', product: self.group, customertype: 'group_percent', customer: user.account.discount).exists?
			...
			discount = (price / 100) * discount
			price - discount
		elsif Discount.where(producttype: 'code_percent', product: self.code, customertype: 'code_percent', customer: user.account.code).exists?
			...
			discount = (price / 100) * discount
			price - discount
		elsif Discount.where(producttype: 'code_percent', product: self.code, customertype: 'group_percent', customer: user.account.discount).exists?
	...
	# elsif Discount.where(producttype: 'group_fixed', product: self.group, customertype: 'code_fixed', customer: user.account.code)
		elsif Discount.where(producttype: 'group_fixed', product: self.group, customertype: 'code_fixed', customer: user.account.code).exists?
			...
			price - discount
		elsif Discount.where(producttype: 'group_fixed', product: self.group, customertype: 'group_fixed', customer: user.account.discount).exists?
			...
			price - discount
		elsif Discount.where(producttype: 'code_fixed', product: self.code, customertype: 'code_fixed', customer: user.account.code).exists?
			...
			price - discount
		elsif Discount.where(producttype: 'code_fixed', product: self.code, customertype: 'group_fixed', customer: user.account.discount).exists?
